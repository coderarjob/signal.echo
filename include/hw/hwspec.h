...
#define BURST_PULSES_TEST_OUTPUT_GPIO       DIGITAL_OUTPUT_GPIO
#define BURST_PULSES_TEST_OUTPUT_PIN        DIGITAL_OUTPUT_PIN_NO0
#define BURST_PULSES_TEST_OUTPUT_PIN_SHIFT  DIGITAL_OUTPUT_PIN_SHIFT
#define BURST_PULSES_TEST_OUTPUT_PIN_COUNT  1
#define BURST_PULSES_TEST_OUTPUT_PIN_MASK   (1 << BURST_PULSES_TEST_OUTPUT_PIN)
